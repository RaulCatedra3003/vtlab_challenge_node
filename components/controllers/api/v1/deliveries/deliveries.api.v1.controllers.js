...
// CRUD requests
// deliveries
router.route('/getbydateandweight')
  .get(
    (req, res, next) => handler(getValidator, req, res, next, validations['getByDateAndWeight']),
    (req, res, next) => responses(deliveriesCommonServices.getByDateAndWeight, req, res, next));
